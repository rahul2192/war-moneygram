  ...
  public <T> T getController(String controller){
    ...
    if (ret == null){
      if (org.cruxframework.crux.core.client.utils.StringUtils.unsafeEquals(controller, "mainController")){
        money.client.MainController_ControllerProxy __cont  = new money.client.MainController_ControllerProxy(this.view);
        __cont.screen = iocContainer.getmoney_client_MainController_MainView(org.cruxframework.crux.core.client.ioc.IoCResource.Scope.LOCAL, null);
